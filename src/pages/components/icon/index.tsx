    ...
    <Space direction="vertical" style={{ display: 'flex' }}>
      ...
      <Card title="Iconify Icons">
        ...
        <div className="mt-4 flex gap-4">
          <IconifyIcon icon="solar:emoji-funny-square-bold-duotone" size={24} color={colorPrimary} />
          <IconifyIcon icon="solar:emoji-funny-square-bold-duotone" size={24} color={colorInfo} />
          <IconifyIcon icon="solar:emoji-funny-square-bold-duotone" size={24} color={colorSuccess} />
          <IconifyIcon icon="solar:emoji-funny-square-bold-duotone" size={24} color={colorWarning} />
          <IconifyIcon icon="solar:emoji-funny-square-bold-duotone" size={24} color={colorError} />
        </div>
      </Card>
