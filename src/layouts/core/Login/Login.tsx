...
import { LoginStateProvider } from '@/Application'
...
function Login() {
  ...
  return (
    <Layout className="relative flex !min-h-screen !w-full !flex-row">
      ...
      >
        <div className="text-3xl font-bold leading-normal lg:text-4xl xl:text-5xl">{import.meta.env.VITE_GLOB_APP_TITLE}</div>
      ...
      <div className="m-auto max-w-[480px] w-full flex flex-col justify-center px-[16px] !h-screen lg:px-[64px]">
        <LoginStateProvider>
          <LoginForm />
          <MobileForm />
          <QrCodeFrom />
